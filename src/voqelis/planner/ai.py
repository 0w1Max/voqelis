        ...
        "tasks": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "period": {"type": ["string", "null"], "enum": ["morning", "day", "evening", "night", None]},
                    "preferred_time": {"type": ["string", "null"], "format": "time"},
                    "relation": {"type": ["string", "null"], "enum": ["before", "after", None]},
                    "anchor": {"type": ["string", "null"], "enum": ["breakfast", "lunch", "dinner", None]},
